	...
	<form:form method="POST" commandName="loginpage">
		...
		<div class="loginDiv" style="display: none">
			<div class="loginLabel">
				Log in <a style="font: 12px helvetica, arial, sans-serif;"
					href="SignUp">Need an Account?</a> <span
					id="oyc-login-signup-close" class="boxCloser">&nbsp;</span>
			</div>
			<div id="oyc_login_form">
				<form:input class="form-signin" path="emailId" id="oyc_email"
					type="text" placeholder="email"></form:input>
				<form:errors id="email_error" path="emailId" cssClass="error" />
				<form:input class="form-signin" id="oyc_pass" path="password"
					name="oyc_name_pass" placeholder="password" type="password"
					autocomplete="off"></form:input>
				<form:errors id="password_error" path="password" cssClass="error" />
				<button id="oyc_login_btn" class="btn btn-small btn-primary"
					style="float: none" type="submit">Log In</button>
				<!--<input id="oyc_login_btn" class="btn btn-small btn-primary" style="float:none" type="submit" ></input>-->


				</br> <label for="type">User Type: </label>
				<form:radiobutton path="role" value="Organizer" />
				Organizer
				<form:radiobutton path="role" value="Speaker" />
				Speaker
				...
				<div class="item active">
					<div class="container">
						<div class="carousel-caption" height="200px">
							...
							<p>
								<a class="btn btn-large btn-primary" id="p1_login">Login Now</a>
							</p>
						</div>
					</div>
				</div>
				<div class="item">
					<div class="container">
						<div class="carousel-caption" height="200px">
							...
							<p>
								<a class="btn btn-large btn-primary" id="p2_login">Login Now</a>
							</p>
						</div>
					</div>
				</div>
				<div class="item">
					<div class="container">
						<div class="carousel-caption" height="200px">
							...
							<p>All the materials of the organized conference on Secure
								Cloud for all time access.</p>
							<p>
								<a class="btn btn-large btn-primary" id="p3_login">Login Now</a>
							</p>
						</div>
					</div>
				</div>
