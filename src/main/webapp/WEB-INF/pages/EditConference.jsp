...
<meta name="description" content="Update Conference">
     ...
     <div class="row-fluid">
        <div class="span2">
          <div class="well sidebar-nav" height="90%">
			...
			<!--/span-->
			<div class="span5">
				<form:form method="post" modelAttribute="conference" action="/UpdateConference/${conference.id}" class="form-signin">
					<div class=offset3>
